...
var authRuleRows = []authRuleRow{
	...
	{Kinds: humanOnly, Operations: authOperations(
		...
		"env rename", "env reorder",
		"folder list", "folder show", "folder create", "folder rename", "folder delete",
		"key list", "key show", "key group list", "key group show",
		"values list", "values get", "values declare", "values diff",
		"values import", "values pending",
		"revision list", "revision rollback",
		"pin create", "pin release",
		"approval policy list", "approval policy create", "approval policy update", "approval policy delete",
		"approval request list", "approval request approve", "approval request reject",
		"approval request merge", "approval request bypass",
		...
		"access registration show", "access registration set", "access registration delete",
	...
	{Kinds: humanOrMachine, Operations: authOperations(
		...
		"values set", "values copy", "values publish", "pin list", "revision show",
