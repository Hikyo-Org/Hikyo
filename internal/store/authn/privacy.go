...
func (r *Resolver) PrivacyAccount(ctx context.Context, principal string) (PrivacyAccountView, error) {
	if r.sq != nil {
		...
		return PrivacyAccountView{a.ID, a.PrincipalID, a.Username, a.DisplayName, nullStringPtr(a.Email), at, a.PrivacyState}, err
	}
	a, err := r.pg.PrivacyAccount(ctx, principal)
	if err != nil {
		return PrivacyAccountView{}, notFoundOr(err)
	}
	return PrivacyAccountView{a.ID, a.PrincipalID, a.Username, a.DisplayName, pgTextPtr(a.Email), a.CreatedAt.Time, a.PrivacyState}, nil
}
