...
SELECT COUNT(*) FROM scim_users WHERE org_id = sqlc.arg(org_id) AND binding_id = sqlc.arg(binding_id) AND user_name_lower = sqlc.arg(filter_value);

-- name: PageSCIMUsersByUserName :many
SELECT id, org_id, binding_id, account_id, user_name, user_name_lower, external_id,
       subject, active, attributes, created_at, updated_at
FROM scim_users WHERE org_id = sqlc.arg(org_id) AND binding_id = sqlc.arg(binding_id) AND user_name_lower = sqlc.arg(filter_value)
...
SELECT COUNT(*) FROM scim_users WHERE org_id = sqlc.arg(org_id) AND binding_id = sqlc.arg(binding_id) AND external_id = sqlc.arg(filter_value);

-- name: PageSCIMUsersByExternalID :many
SELECT id, org_id, binding_id, account_id, user_name, user_name_lower, external_id,
       subject, active, attributes, created_at, updated_at
FROM scim_users WHERE org_id = sqlc.arg(org_id) AND binding_id = sqlc.arg(binding_id) AND external_id = sqlc.arg(filter_value)
ORDER BY id LIMIT sqlc.arg(page_limit) OFFSET sqlc.arg(page_offset);
...
SELECT COUNT(*) FROM scim_groups WHERE org_id = sqlc.arg(org_id) AND binding_id = sqlc.arg(binding_id) AND display_name_lower = sqlc.arg(filter_value);

-- name: PageSCIMGroupsByDisplayName :many
SELECT id, org_id, binding_id, display_name, display_name_lower, external_id,
       created_at, updated_at
FROM scim_groups WHERE org_id = sqlc.arg(org_id) AND binding_id = sqlc.arg(binding_id) AND display_name_lower = sqlc.arg(filter_value)
ORDER BY id LIMIT sqlc.arg(page_limit) OFFSET sqlc.arg(page_offset);

-- externalId is not unique on groups either.
-- name: CountSCIMGroupsByExternalID :one
SELECT COUNT(*) FROM scim_groups WHERE org_id = sqlc.arg(org_id) AND binding_id = sqlc.arg(binding_id) AND external_id = sqlc.arg(filter_value);

-- name: PageSCIMGroupsByExternalID :many
SELECT id, org_id, binding_id, display_name, display_name_lower, external_id,
       created_at, updated_at
FROM scim_groups WHERE org_id = sqlc.arg(org_id) AND binding_id = sqlc.arg(binding_id) AND external_id = sqlc.arg(filter_value)
ORDER BY id LIMIT sqlc.arg(page_limit) OFFSET sqlc.arg(page_offset);
