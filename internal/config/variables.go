...
var variableInventory = []VariableDescriptor{
	...
	{Key: "HIKYO_PG_STORAGE_KUBELET_URL", Audience: VariableServer, Scope: VariableNode, Activation: VariableBootstrap, Secret: false, Import: VariableExternal},
	{Key: "HIKYO_PG_STORAGE_NAMESPACE", Audience: VariableServer, Scope: VariableNode, Activation: VariableBootstrap, Secret: false, Import: VariableExternal},
	{Key: "HIKYO_PG_STORAGE_NODE", Audience: VariableServer, Scope: VariableNode, Activation: VariableBootstrap, Secret: false, Import: VariableExternal},
	{Key: "HIKYO_PG_STORAGE_PVC", Audience: VariableServer, Scope: VariableNode, Activation: VariableBootstrap, Secret: false, Import: VariableExternal},
