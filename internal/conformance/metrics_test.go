...
func pinnedMetricRegistry() []metricFamily {
	...
	return []metricFamily{
		...
		{Name: "hikyo_data_volume_capacity_known", MaxSeries: 1},
		{Name: "hikyo_data_volume_used_percent", MaxSeries: 1},
		{Name: "hikyo_data_volume_warn", MaxSeries: 1},
		{Name: "hikyo_data_volume_critical", MaxSeries: 1},
		{Name: "hikyo_root_escrow_verified", MaxSeries: 1},
		{Name: "hikyo_root_escrow_verified_timestamp_seconds", MaxSeries: 1},
		{Name: "hikyo_root_rotation_pending", MaxSeries: 1},
		{Name: "hikyo_reencrypt_pending_scopes", MaxSeries: 1},
		{Name: "hikyo_last_reencrypt_success_timestamp_seconds", MaxSeries: 1},
		{Name: "hikyo_pins_expired", MaxSeries: 1},
		{Name: "hikyo_pins_expiring_day", MaxSeries: 1},
		{Name: "hikyo_pins_expiring_week", MaxSeries: 1},
		{Name: "hikyo_pins_expiring_month", MaxSeries: 1},
