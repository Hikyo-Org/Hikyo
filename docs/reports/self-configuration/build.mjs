...
<div class="shell">
  ...
  <main class="document" id="overview">
    ...
    <section class="section" id="delivery" aria-labelledby="delivery-title">
      ...
      <p class="caption">The <a href="./validation.md">validation record</a> includes commands, review findings and delivery limits. No production deployment is implied.</p>
