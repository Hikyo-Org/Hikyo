...
<div class="shell">
  ...
  <main class="document" id="overview">
    <div class="masthead"><span class="eyebrow">Engineering / Decision report</span><span class="stamp"><b>Design complete</b> · 06 Sep 2026</span></div>
    <header class="hero">
    ...
    <section class="section" id="catalogue" aria-labelledby="catalogue-title">
      ...
      <p class="section-lede">A closed first-delivery catalogue for each supporting instance: complete email configuration and release notifications. Each owner validates its own schema and values; a remote may run a different version. Bootstrap and security-sensitive deployment controls keep their existing authority.</p>
      ...
      <h3 class="subheading">What stays outside this project</h3><p class="section-lede">These are explicit boundaries of the first delivery, not claims that those settings are impossible to manage through future dedicated workflows.</p>
    ...
    <section class="section" id="delivery" aria-labelledby="delivery-title">
      ...
      <p class="section-lede">The approved design is implemented in this branch. The milestones retain their acceptance requirements; the evidence below distinguishes verified behavior from remaining delivery steps.</p>
      ...
      <p class="caption">The <a href="./validation.md">validation record</a> and <a href="https://github.com/Hikyo-Org/Hikyo/pull/686">PR #686</a> includes commands, review findings and delivery limits. No production deployment is implied.</p>
