...
printf '{"schema":"hikyo.dev/trust-metadata/v1","sequence":4,"highest_release":"0.0.9","highest_release_sequence":6,"recovery":{"id":"recovery-1","sha256":"%064d"},"event":{"type":"rotation","signed_by":"recovery-1"},"primary_keys":[{"id":"primary-1","public_key":"primary-1.pub","sha256":"%064d","valid_from_release_sequence":1,"valid_through_release_sequence":null,"revoked":false}],"releases":[{"version":"0.0.9","sequence":6,"manifest_sha256":"%064d"}],"pending_release":{"version":"0.1.0","sequence":7,"manifest_sha256":"%064d"}}\n' 3 2 1 0 \
