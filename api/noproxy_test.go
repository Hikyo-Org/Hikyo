...
var pinnedContractSurface = map[string]bool{
	...
	"GET /api/v1/instance/registration-policy":                                                 true,
	"PUT /api/v1/instance/registration-policy":                                                 true,
	"DELETE /api/v1/instance/registration-policy":                                              true,
	"GET /api/v1/orgs/{org}/registration-policy":                                               true,
	"PUT /api/v1/orgs/{org}/registration-policy":                                               true,
	"DELETE /api/v1/orgs/{org}/registration-policy":                                            true,
	"POST /api/v1/auth/credential/establish":                                                   true,
	"POST /api/v1/auth/identities/link":                                                        true,
	"POST /api/v1/auth/local/login":                                                            true,
	"POST /api/v1/auth/login/challenge/{challenge}/totp":                                       true,
	"POST /api/v1/auth/login/challenge/{challenge}/webauthn/finish":                            true,
	"POST /api/v1/auth/login/challenge/{challenge}/webauthn/start":                             true,
