...
- **Scale (decided 2026-09-16, Storybook design pass, PR #755):** 11px eyebrow and badge (500, uppercase, 0.06em tracking, tertiary ink) · 13px captions: field labels, legends, ledes, hints, mono values · 14px body, h3 and panel titles (700) · 16px h2 (700) · 20px h1 (700). No other sizes. Tokens `--fs-xs/sm/md/lg/xl/mono` (in `web/src/ui/ui.css` until the migration moves them to `tokens.css`).
