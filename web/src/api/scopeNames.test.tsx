...
it('resolves the addressed project and environment without reading a directory', async () => {
  ...
  vi.stubGlobal('fetch', async (request: Request) => {
    ...
    if (path === '/api/v1/orgs/org_00000000-0000-0000-0000-000000000001') return Response.json({ id: 'org_00000000-0000-0000-0000-000000000001', name: 'Acme', active: true, created_at, origin: 'manual' });
